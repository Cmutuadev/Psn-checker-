...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ADMIN_ID         = 8760363324
FEEDBACK_CHANNEL = -1003952934184   # channel where approved hits are posted
...
def _channel_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[[
        InlineKeyboardButton(text="𝗕𝘂𝘆 𝗡𝗼𝘄", url="https://t.me/CARDXV4_BOT?start=buy")
    ]])
...
async def feedback_cmd(message: types.Message):
    ...
    # ── Confirm to user INSTANTLY — no waiting ──────────────────────────────
    ...
    # ── Forward all hit messages to admin + send info block — concurrently ──
