...
async def sp_command(message: types.Message):
    ...
    if not args:
        await message.reply(
            "💳 <b>𝗦𝗵𝗼𝗽𝗶𝗳𝘆 𝟭$ 𝗚𝗮𝘁𝗲</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "📟 𝗖𝗼𝗺𝗺𝗮𝗻𝗱: <code>/sp</code>\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "📌 𝗨𝘀𝗮𝗴𝗲: <code>/sp CC|MM|YY|CVV</code>\n\n"
            "📝 𝗘𝘅𝗮𝗺𝗽𝗹𝗲: <code>/sp 4111111111111111|12|25|123</code>",
            parse_mode="HTML"
        )
        return
    ...
    if not card:
        await message.reply("❌ <b>No card found!</b>\nUsage: <code>/sp CC|MM|YY|CVV</code>", parse_mode="HTML")
        return
    ...
    asyncio.create_task(process_sp_check(message, proc_msg, user, user_id, formatted_cc, cc, plan_name, site, proxy))

async def process_sp_check(message, proc_msg, user, user_id, formatted_cc, cc, plan_name, site, proxy):
